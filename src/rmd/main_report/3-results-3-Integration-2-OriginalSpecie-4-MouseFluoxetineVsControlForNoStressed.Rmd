#### Mouse Fluoxetine VS Control for NoStressed in Dentate Gyrus{#resultsIntegrationOriginalSpecieMouseFluoxetineVsControlForNoStressed}

This section corresponds to the third meta-analysis requested by El Chérif.
Note GSE54307 is only a 1 VS 1 comparison.

```{r resultsIntegrationOriginalSpecieMouseFluoxetineVsControlForNoStressedSettings}
fig_width <- 34
fig_height <- 32
n_cols <- 15
...
The xlsx table with all genes is available [here](xlsx/resultsIntegrationOriginalSpecieMouseFluoxetineVsControlForNoStressedExportAllGenes.xlsx)

```{r resultsIntegrationOriginalSpecieMouseFluoxetineVsControlForNoStressedExportAllGenes}
# Export to xlsx

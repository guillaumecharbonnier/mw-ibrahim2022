### GSE84185 {#resultsMicroarrayGSE84185}

```{r resultsMicroarrayGSE84185}
...
#### Stressed VS Unstressed {#resultsMicroarrayGSE84185StressedVsUnstressed}

##### Default settings {#resultsMicroarrayGSE84185StressedVsUnstressedDefaultSettings}

```{r resultsMicroarrayGSE84185StressedVsUnstressedDefaultSettings}
fData(gset[[1]]) <- cbind(
  fData(gset[[1]]),
...
gsms <- paste0(
  "11111111000000000000000011111111111111110000000000",
  "0000001111111111111111000000000000000011111111"
)
...
gs <- factor(sml)
groups <- make.names(c("Stressed", "Unstressed"))
levels(gs) <- groups
gset$group <- gs

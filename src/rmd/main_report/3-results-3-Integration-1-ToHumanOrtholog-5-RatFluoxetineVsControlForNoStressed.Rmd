#### Rat Fluoxetine VS Control for NoStressed  in Dentate Gyrus{#resultsIntegrationRatFluoxetineVsControlNoStressed}

This section corresponds to the fourth meta-analysis requested by El Chérif.

```{r resultsIntegrationRatFluoxetineVsControlNoStressedSettings}
fig_width <- 7
fig_height <- 7
n_cols <- 1
```

```{r resultsIntegrationRatFluoxetineVsControlNoStressedAlphabet, dependson="resultsIntegrationRatFluoxetineVsControlNoStressedSettings", fig.height=fig_height, fig.width=fig_width, fig.cap="Alphabetically-sorted genes significant in at least one comparison (padj < 0.05). + and – signs highlight respectively upregulated and downregulated genes (|logFoldChange| > 0.1 and raw pvalue < 0.05)."}
cols_to_keep <- c(
  "hugo_symbol",
  "ensembl_gene_id",
  "baseMean",
...
```{r resultsIntegrationRatFluoxetineVsControlNoStressedConsensus, dependson="resultsIntegrationRatFluoxetineVsControlNoStressedSettings", fig.height=fig_height, fig.width=fig_width, fig.cap="Consensus-sorted genes significant in at least one comparison (padj < 0.05). + and – signs highlight respectively upregulated and downregulated genes (|logFoldChange| > 0.1 and raw pvalue < 0.05)."}
...
```{r resultsIntegrationRatFluoxetineVsControlNoStressedConsensusPadj0p0001, dependson="resultsIntegrationRatFluoxetineVsControlNoStressedSettings", fig.height=fig_height, fig.width=fig_width, fig.cap="Consensus-sorted genes significant in at least one comparison (padj < 0.0001). + and – signs highlight respectively upregulated and downregulated genes (|logFoldChange| > 0.1 and raw pvalue < 0.05). Underlying table is available [here](xlsx/resultsIntegrationRatFluoxetineVsControlNoStressedConsensusPadj0p0001.xlsx)"}

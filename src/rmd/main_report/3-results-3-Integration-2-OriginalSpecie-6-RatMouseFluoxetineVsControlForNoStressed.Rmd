#### Rat+Mouse Fluoxetine VS Control for NoStressed in Dentate Gyrus{#resultsIntegrationOriginalSpecieRatMouseFluoxetineVsControlForNoStressed}

```{r resultsIntegrationOriginalSpecieRatMouseFluoxetineVsControlForNoStressedSettings}
fig_width <- 40
fig_height <- 32
n_cols <- 17
```

```{r resultsIntegrationOriginalSpecieRatMouseFluoxetineVsControlForNoStressedAlphabet, dependson="resultsIntegrationOriginalSpecieRatMouseFluoxetineVsControlForNoStressedSettings", fig.height=fig_height, fig.width=fig_width, fig.cap="Alphabetically-sorted genes significant in at least one comparison (padj < 0.05). + and – signs highlight respectively upregulated and downregulated genes (|logFoldChange| > 0.1 and raw pvalue < 0.05)."}
cols_to_keep <- c(
  "Gene.name",
  "baseMean",
  "log2FoldChange",
...
The xlsx table with all genes is available [here](xlsx/resultsIntegrationOriginalSpecieRatMouseFluoxetineVsControlForNoStressedExportAllGenes.xlsx)

```{r resultsIntegrationOriginalSpecieRatMouseFluoxetineVsControlForNoStressedExportAllGenes}
# Export to xlsx

##### Fluoxetine VS ModelOfDepression in Hippocampus{#resultsRnaseqSRP084288FluoxetineVsModelOfDepressionInHippocampusComputeDeseq2}

```{r resultsRnaseqSRP084288FluoxetineVsModelOfDepressionInHippocampusComputeDeseq2}
...
rowData(dds)$log2FoldChange <- log2((assay(dds[,"SRR4123960"])+1) / (assay(dds[,"SRR4123957"])+1))

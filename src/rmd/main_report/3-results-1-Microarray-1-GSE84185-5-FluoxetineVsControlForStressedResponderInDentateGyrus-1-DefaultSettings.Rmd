#### Fluoxetine VS Control for Stressed Responder in Dentate Gyrus{#resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrus}

##### Default settings {#resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettings}

```{r resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettings}
...
gset <- gset[
  ...
  gset[["tissue:ch1"]] %in% c(
    ...
    gset[["description"]] %like% "Dent_Gyr-S-T|_7$|_8$|_10$|_22$|_38$"
]
# Responders: 7, 8, 10, 22
# Non-responders: 14, 17, 27
...
```{r resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettingsToIntegrationOriginalSpecie}
...
project <- "GSE84185"
comparison <- "FluoxetineVsControlForStressedResponderInDentateGyrus"
tT2$project <- project
...
```{r resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettingsToIntegration}
...
```{r resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettingsHeatmapSettings}
fig_height <- 30
n_top_genes <- 200
gsubset <- gset[fData(gset)[["ID"]] %in% tT2[1:n_top_genes, ]$ID, ]
```

```{r resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettingsHeatmapRaw, dependson="resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettingsHeatmapSettings", fig.height=fig_height}
set.seed(123)
Heatmap(
  exprs(gsubset),
  row_labels = fData(gsubset)$GENE_SYMBOL,
...
```{r resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettingsHeatmapZscore, dependson="resultsMicroarrayGSE84185FluoxetineVsControlForStressedResponderInDentateGyrusDefaultSettingsHeatmapSettings", fig.height=fig_height}
set.seed(123)
Heatmap(

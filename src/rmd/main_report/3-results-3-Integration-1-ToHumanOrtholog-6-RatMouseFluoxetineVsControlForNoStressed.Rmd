#### Rat+Mouse Fluoxetine VS Control for NoStressed in Dentate Gyrus{#resultsIntegrationRatMouseFluoxetineVsControlForNoStressed}

```{r resultsIntegrationRatMouseFluoxetineVsControlForNoStressedSettings}
fig_width <- 40
fig_height <- 32
n_cols <- 17
```

```{r resultsIntegrationRatMouseFluoxetineVsControlForNoStressedAlphabet, dependson="resultsIntegrationRatMouseFluoxetineVsControlForNoStressedSettings", fig.height=fig_height, fig.width=fig_width, fig.cap="Alphabetically-sorted genes significant in at least one comparison (padj < 0.05). + and – signs highlight respectively upregulated and downregulated genes (|logFoldChange| > 0.1 and raw pvalue < 0.05)."}
cols_to_keep <- c(
  "hugo_symbol",
  "ensembl_gene_id",
  "baseMean",
...
```{r resultsIntegrationRatMouseFluoxetineVsControlForNoStressedConsensus, dependson="resultsIntegrationRatMouseFluoxetineVsControlForNoStressedSettings", fig.height=fig_height, fig.width=fig_width, fig.cap="Consensus-sorted genes significant in at least one comparison (padj < 0.05). + and – signs highlight respectively upregulated and downregulated genes (|logFoldChange| > 0.1 and raw pvalue < 0.05)."}
...
```{r resultsIntegrationRatMouseFluoxetineVsControlForNoStressedConsensusPadj0p0001, dependson="resultsIntegrationRatMouseFluoxetineVsControlForNoStressedSettings", fig.height=fig_height, fig.width=fig_width, fig.cap="Consensus-sorted genes significant in at least one comparison (padj < 0.0001). + and – signs highlight respectively upregulated and downregulated genes (|logFoldChange| > 0.1 and raw pvalue < 0.05). Underlying table is available [here](xlsx/resultsIntegrationRatMouseFluoxetineVsControlForNoStressedConsensusPadj0p0001.xlsx)"}
